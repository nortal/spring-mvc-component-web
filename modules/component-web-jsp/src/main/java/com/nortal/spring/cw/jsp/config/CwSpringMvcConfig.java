 ...
 */
@Configuration
@ComponentScan(basePackages = { "com.nortal.spring.cw.jsp.web.portal", "com.nortal.spring.cw.jsp.web.portal.menu" })
public class CwSpringMvcConfig extends WebMvcConfigurationSupport {
   ...
   protected void addResourceHandlers(ResourceHandlerRegistry registry) {
      registry.addResourceHandler("/js/**").addResourceLocations("/js/").setCachePeriod(3000);
      registry.addResourceHandler("/gfx/**").addResourceLocations("/gfx/").setCachePeriod(3000);
      registry.addResourceHandler("/static/**").addResourceLocations("/static/").setCachePeriod(3000);
      registry.addResourceHandler("/favicon.ico").addResourceLocations("/favicon.ico").setCachePeriod(3000);
